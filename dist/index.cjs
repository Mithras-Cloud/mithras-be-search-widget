...
var BookingSearchWidget = (props) => {
  ...
  const groupsSummary = react.useMemo(() => summarizeGuests(state.groups), [state.groups]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: THEME_CLASS, "data-theme": (_a = props.theme) != null ? _a : "light", role: "region", "aria-live": "polite", children: [
    /* @__PURE__ */ jsxRuntime.jsx("h2", { children: "Booking search" }),
    /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, noValidate: true, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "yw-row yw-row--inline", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Check-in" }),
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Check-out" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "input",
            {
              type: "date",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "yw-row yw-row--inline", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "POS" }),
          /* @__PURE__ */ jsxRuntime.jsx("select", { value: state.pos, onChange: (event) => handleStateChange({ pos: event.target.value }), children: POS_OPTIONS.map((option) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: option, children: option }, option)) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Language" }),
          /* @__PURE__ */ jsxRuntime.jsx("select", { value: state.locale, onChange: (event) => handleStateChange({ locale: event.target.value }), children: LOCALE_OPTIONS.map((option) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: option.value, children: option.label }, option.value)) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Currency" }),
          /* @__PURE__ */ jsxRuntime.jsx("select", { value: state.currency, onChange: (event) => handleStateChange({ currency: event.target.value }), children: CURRENCY_OPTIONS.map((currency) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: currency, children: currency }, currency)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Product ID" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("section", { className: "yw-groups", "aria-label": "Guests", children: [
        state.groups.map((group, index) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "yw-group", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("header", { className: "yw-summary", children: [
            "Room ",
            index + 1
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "yw-group-controls", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Rooms" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Adults" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Children ages" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("label", { children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Infants" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "input",
                {
                  type: "number",
          ...
          state.groups.length > 1 && /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "yw-secondary", onClick: addGroup, children: "Add room" }),
        /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "yw-summary", children: [
          groupsSummary.rooms,
          " rooms \xB7 ",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("label", { children: /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
      ...
      errorMessage && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "yw-error", children: errorMessage }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "yw-actions", children: [
        /* @__PURE__ */ jsxRuntime.jsx("button", { type: "submit", className: "yw-primary", disabled: state.isSearching, children: state.isSearching ? "Searching\u2026" : "Search" }),
        /* @__PURE__ */ jsxRuntime.jsx("small", { className: "yw-summary", children: formatGroupsForm(state.groups) })
      ] })
    ] })
  ] });
};
...
exports.BookingSearchWidget = BookingSearchWidget;
exports.buildSearchPayload = buildSearchPayload;
exports.createInitialState = createInitialState;
exports.formatGroupsForm = formatGroupsForm;
exports.parseGroupsForm = parseGroupsForm;
exports.summarizeGuests = summarizeGuests;
